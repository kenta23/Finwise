...
export default function ExpenseCategory() {
	...
	function handleSubmitCategory() {
		...
		const category: categoryType | undefined = categoryTypes.find(
					...
					{fetchCategories.map((item, index) => {
						...
						return (
							...
							>
								...
								<div className="flex gap-1 shrink-0 justify-center items-center group-hover:opacity-70 transition-opacity duration-300">
									{/**ACTIONS */}
									<Button
										variant="ghost"
										size="icon"
										className="cursor-pointer hover:bg-green-100 hover:text-green-600 dark:hover:bg-green-900/20 dark:hover:text-green-400"
									...
									<Button
										variant="ghost"
										size="icon"
										className="cursor-pointer hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/20 dark:hover:text-blue-400"
									...
									<Button
										variant="ghost"
										size="icon"
										className="cursor-pointer hover:bg-red-100 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400"
							...
							<div className="flex items-center gap-4">
								...
								<div className="flex-1">
									...
									<p className="text-sm text-muted-foreground mt-1">
										{categoryTypes.find((cat) => cat.id === viewingCategory.categoryId)?.name ||
											"Unknown"}{" "}
										Category
									</p>
								</div>
							...
							<div className="flex items-center gap-4 p-4 bg-muted rounded-lg">
								...
								<div className="flex-1">
									...
									<p className="text-sm text-muted-foreground">
										{categoryTypes.find((cat) => cat.id === deletingCategory.categoryId)?.name ||
											"Unknown"}{" "}
										Category
									</p>
								</div>
